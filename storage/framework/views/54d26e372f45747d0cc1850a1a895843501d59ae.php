		...
		<header id="tg-header" class="tg-header tg-haslayout">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<ul class="tg-addressinfo">
								...
								<li>
									...
									<span>+62 81217033258</span>
								</li>
								<li>
									<i class="icon-heart-pulse"></i>
									<span><a href="mailto:support@domain.com">csjahitindotcom@jahitin.com</a></span>
								</li>
							</ul>
			...
			<div class="tg-logonav">
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<strong class="tg-logo"><a href="i<?php echo e(url('/')); ?>"><img src="images/logo.png" alt="company logo here"></a></strong>
							<div class="tg-navigationarea">
								<nav id="tg-nav" class="tg-nav">
									...
									<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
										<ul>
											...
											<li><a href="<?php echo e(url('/transaksi')); ?>">Kebaya</a></li>
								...
								<a class="tg-btn tg-btnstartcustomizing" href="#" >Login</a>
							</div>
						</div>
					</div>
				</div>
									...
									<div class="col-xs-12 col-sm-6 col-md-5 col-lg-4">
										<div class="tg-productgallery">
											<div id="tg-viewslider" class="tg-viewslider tg-productgalleryslider owl-carousel">
												<figure class="item"><img src="images/products/img-11.png" alt="image description"></figure>
												<figure class="item"><img src="images/products/img-11.png" alt="image description"></figure>
												<figure class="item"><img src="images/products/img-11.png" alt="image description"></figure>
												<figure class="item"><img src="images/products/img-11.png" alt="image description"></figure>
											</div>
										...
										<div class="tg-producttextbox">
											...
											<div class="tg-description">
												<div class="form-group<?php echo e($errors->has('tanggal') ? ' has-error' : ''); ?>">
						                            <label for="tanggal" class="col-md-4 control-label">Tanggal Booking:</label>

						                            <div class="col-md-6">
						                                <input id="tanggal" type="datetime-local" class="form-control" name="tanggal" value="<?php echo e(old('tanggal')); ?>">
						                                
						                                <h6><i>Format : mm-dd-yyyy hh:mm AM/PM</i></h6>
						                        ...
						                        <div class="form-group<?php echo e($errors->has('telepon') ? ' has-error' : ''); ?>">
						                            ...
						                            <div class="col-md-6">
						                                <input id="telepon" type="text" class="form-control" name="telepon" value="<?php echo e(old('telepon')); ?>">
											...
											<div class="tg-producttextboxfoot">
												<a class="tg-btn" href="<?php echo e(url('/transaksiSukses')); ?>">Order</a>
											</div>
										</div>
									</div>
								</div>
		...
		<footer id="tg-footer" class="tg-footer tg-haslayout">
			...
			<div class="tg-footerbar">
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<span class="tg-copyright">2017 All Rights Reserved © Jahitin.com</span>
							<nav class="tg-addnav">
								<ul>
